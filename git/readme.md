git init - inicia um repositório git na pasta raiz do projeto (será criada uma pasta oculta de nome .git, é ela que representa o repositório e contem toda a inteligencia do git)
